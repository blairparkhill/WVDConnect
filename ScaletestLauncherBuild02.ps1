...
if (-not (Test-Path "C:\bpleva03_launcher_install481"))
{
    Invoke-WebRequest -OutFile "C:\bpleva03_launcher_install481.zip" -Uri "https://github.com/blairparkhill/WVDConnect/raw/master/bpleva03_launcher_install481.zip"
    Expand-Archive -Path "C:\bpleva03_launcher_install481.zip" -DestinationPath "C:\bpleva03_launcher_install481"
}
...
{
    cmd /c msiexec /i "C:\bpleva03_launcher_install481\setup.msi" /qn /liewa "C:\bpleva03_launcher_install481\install.log"        
}
